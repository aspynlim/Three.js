...
const graidentTexture = textureLoader.load('/textures/gradients/3.png')
...
const torus = new THREE.Mesh(
    new THREE.TorusGeometry(0.5, 0.1, 10, 30),
    material
)
...
const tick = () =>
{
    ...
    sphere.rotation.x = speed * elapsedTime
    plane.rotation.x = speed * elapsedTime
    torus.rotation.x = speed * elapsedTime
